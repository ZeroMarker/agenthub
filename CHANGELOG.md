...
- **Users & permissions (Config)**: `UserManager` backed by `users.yaml` / `permissions.yaml`;
...
### Changed (UI polish + fixes)
- **Full M3 token migration** — ConfigManager, SkillManager, PromptManager, SessionManager,
